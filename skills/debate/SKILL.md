...
```bash
/debate Should we use universal evaluate-artifact skill or specialized skills for each artifact type?
/debate What's the best approach for evaluation feedback - concise scores or detailed analysis?
/debate How should we balance evaluation accuracy with performance requirements?
```bash
